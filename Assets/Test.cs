...
public class Test : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        AssetBundleCreateRequest request1 = AssetBundle.LoadFromFileAsync(Application.streamingAssetsPath + "/ui/res/bg01.png.ab");
        yield return request1;

        AssetBundleCreateRequest request2 = AssetBundle.LoadFromFileAsync(Application.streamingAssetsPath + "/ui/res/main_mp_bar.png.ab");
